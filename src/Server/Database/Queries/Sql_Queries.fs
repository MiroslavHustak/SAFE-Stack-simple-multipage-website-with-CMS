...
module SqlQueries = 
    ...
    let queryDelete = "DELETE FROM CENIK WHERE Id = @id" 
    let queryExists = "SELECT Id FROM CENIK WHERE EXISTS (SELECT Id FROM CENIK WHERE CENIK.Id = @id)"
    let querySelect = "SELECT * FROM CENIK WHERE Id = @id"
