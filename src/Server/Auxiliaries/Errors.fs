...
let error0 ex =
    ...
    let message = sprintf "Vyskytla se chyba v nastavení. Oprav hodnoty v nastavení a klikni na tlačítko \"OK\" pro restart programu. K tomu dopomáhej ti následující chybové hlášení: \n\n%s"
                   <| ex
    restartApp "Závažná chyba v nastavení" message Array.empty
...
let error3 str1 str2 = 
    ...
    let message = sprintf "Vyskytla se chyba při čtení %s metodou %s, která není způsobena tímto programem. Oprav I/O problém a klikni na \"OK\" pro restart programu."
                  <| str1 <| str2
...
let error5 ex  = 
    ...
    let message = sprintf "Vyskytla se chyba při načítání nastavených hodnot. Odstraň problém a klikni na tlačítko \"OK\" pro restart programu. K tomu dopomáhej ti následující chybové hlášení: \n\n%s"
                  <| ex               
